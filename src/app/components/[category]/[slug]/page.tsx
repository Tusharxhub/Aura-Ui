        ...
        <div className="min-h-screen bg-background pt-20 sm:pt-24 md:pt-32 pb-12 sm:pb-16 md:pb-24">
            <div className="max-w-250 mx-auto px-4 sm:px-6">
                ...
                <div className="space-y-4 mb-8 sm:mb-10">
                    ...
                    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-foreground">{component.name}</h1>
                ...
                <div className="grid gap-8 sm:gap-12 md:gap-16">
                    ...
                    {component.usage && (
                        <div className="space-y-4">
                            <div className="flex items-center justify-between border-b border-border/50 pb-2">
                                <h2 className="text-xs sm:text-sm font-medium text-muted-foreground uppercase tracking-wider">Source Code</h2>
                            </div>
                    ...
                    {component.props && (
                        <div className="space-y-4">
                            <div className="flex items-center justify-between border-b border-border/50 pb-2">
                                <h2 className="text-xs sm:text-sm font-medium text-muted-foreground uppercase tracking-wider">Props</h2>
                            </div>
