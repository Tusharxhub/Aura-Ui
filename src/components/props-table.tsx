...
export function PropsTable({ data }: PropsTableProps) {
    ...
    return (
        <div className="my-6 w-full overflow-hidden rounded-lg border border-border bg-card">
            <table className="w-full text-sm text-left">
                <thead className="bg-secondary/10">
                    <tr className="border-b border-border/50">
                        <th className="p-4 font-semibold text-foreground w-[20%]">Prop</th>
                        <th className="p-4 font-semibold text-foreground w-[20%]">Type</th>
                        <th className="p-4 font-semibold text-foreground w-[20%]">Default</th>
                        <th className="p-4 font-semibold text-foreground w-[40%]">Description</th>
                    </tr>
                </thead>
                <tbody>
                    {data.map((prop, index) => (
