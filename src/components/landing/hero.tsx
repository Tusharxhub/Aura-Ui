    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center pt-24 pb-32 overflow-hidden">
            <div className="absolute inset-0 -z-10">
                <div className="absolute top-10 left-1/2 -translate-x-1/2 w-full max-w-5xl h-[520px] bg-brand/20 blur-[140px] rounded-full opacity-20" />
                <div className="absolute bottom-0 right-0 w-[460px] h-[460px] bg-brand-2/10 blur-[120px] rounded-full opacity-25" />
            </div>

            <div className="max-w-[1200px] w-full mx-auto px-6 grid lg:grid-cols-[1.05fr_0.95fr] gap-14 items-center">
                <div className="max-w-2xl">
                    ...
                    <motion.h1
                        ...
                        className="text-5xl md:text-6xl lg:text-7xl font-semibold tracking-tight text-foreground mb-6 leading-[1.05]"
                    >
                        Build interfaces <br />
                    ...
                    >
                        <Link
                            href="#get-started"
                            className="group inline-flex items-center justify-center px-6 py-3 text-sm font-medium text-background bg-brand rounded-lg hover:bg-brand-2 transition-colors"
                        >
                            Get Started
                        ...
                        <Link
                            href="#components"
                            className="inline-flex items-center justify-center px-6 py-3 text-sm font-medium text-muted-foreground bg-secondary/30 border border-border rounded-lg hover:bg-secondary/50 hover:text-foreground transition-colors"
                        >
                            View Components
                        </Link>
                    </motion.div>
