    ...
    return (
        <section id="get-started" className="py-32 relative overflow-hidden">
            ...
            <div className="max-w-[1200px] mx-auto px-6 text-center">
                <h2 className="text-3xl md:text-4xl font-semibold tracking-tight mb-6">Ready to build?</h2>
                <p className="text-muted-foreground text-lg mb-12">
                    Install once. Compose forever.
                </p>

                <div className="grid gap-6 lg:grid-cols-2 text-left">
                    <div className="relative rounded-2xl border border-border bg-card/60 p-6 shadow-[0_20px_50px_-30px_rgba(0,0,0,0.8)]">
                        <div className="flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-muted-foreground">
                            <Terminal className="w-4 h-4" />
                            Install
                        </div>
                        <div className="mt-4 flex items-center justify-between rounded-lg border border-border bg-background/60 p-4">
                    ...
                    <div className="relative rounded-2xl border border-border bg-card/60 p-6">
                        ...
                        <pre className="mt-4 rounded-lg border border-border bg-background/60 p-4 text-sm text-foreground overflow-x-auto">
                            <code>{usage}</code>
                        </pre>
                    </div>
                </div>
                ...
                <div className="mt-10 grid gap-4 md:grid-cols-2">
                    <Link
                        href="#docs"
                        className="group rounded-2xl border border-border bg-secondary/30 px-6 py-5 text-left transition-all hover:-translate-y-1 hover:border-brand/50 hover:shadow-[0_0_36px_-16px_rgba(107,104,255,0.6)]"
                    >
