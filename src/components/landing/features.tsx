    ...
    return (
        <section id="why" className="py-24 relative overflow-hidden">
            <div className="max-w-[1200px] mx-auto px-6">
                <div className="mb-12">
                    <h2 className="text-3xl md:text-4xl font-semibold tracking-tight">Why Aura UI</h2>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {features.map((feature, idx) => (
                        <motion.div
                            ...
                            className="group p-8 rounded-2xl bg-secondary/20 border border-border hover:border-brand/40 hover:bg-secondary/30 transition-all hover:shadow-[0_0_32px_-18px_rgba(107,104,255,0.65)]"
                        >
